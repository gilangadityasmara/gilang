...
<html lang="en">
  <head>
    ...
    <!-- Main Style -->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/maina.css'); ?>">
    <!-- Responsive Style -->
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
              <div class="contents">
                ...
                <?php
                $str = "https://wa.me/6285336112183?text=Hallo *Gilang*, Saya tertarik dengan CV kamu.";
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="footer-text text-center wow fadeInDown" data-wow-delay="0.3s">
              ...
              <p>© 2019 <a href="" target="_blank">Gilang. </a> All Right Reserved</p>
          </div>
        </div>
      </div>
    </footer>
